# ESP32 Media Viewer Companion User Agreement

Please read this agreement before using ESP32 Media Viewer Companion.

## 1. Acceptance

By selecting "I accept" and using this application, you agree to this User Agreement. If you do not agree, select "Decline" and do not use the application.

## 2. Purpose of the Software

ESP32 Media Viewer Companion is provided to convert media files, prepare firmware-related assets, communicate with supported ESP32 devices, write files to removable storage or device flash, and flash compatible firmware packages.

## 3. User Responsibility

You are responsible for selecting the correct device, COM port, firmware, storage target, media files, and conversion settings. You are responsible for backing up files and accepting the risks of firmware flashing, serial communication, removable storage formatting, and media conversion.

## 4. No Warranty

The software is provided "as is" and "as available" without warranties of any kind, express or implied. The Developer does not warrant that the software will be error-free, uninterrupted, compatible with every device, or fit for any particular purpose.
...
The Developer may update, modify, or discontinue the software at any time. Continued use after an update means you accept the updated software and any updated agreement presented with it.

## 9. Legal Limits

Some jurisdictions do not allow certain warranty exclusions or liability limitations. In those jurisdictions, the limitations in this agreement apply only to the maximum extent permitted by law.

If you do not accept this agreement, the application will close and will not be functional.
